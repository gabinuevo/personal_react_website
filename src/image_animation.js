...
( function( img ) {
  ...
  var Halftone = img.BreathingHalftone = img.BreathingHalftone || {};
  ...
  var Halftone = img.BreathingHalftone || {};
  ...
  var requestAnimationFrame = img.requestAnimationFrame;
  var cancelAnimationFrame = img.cancelAnimationFrame;
  ...
  for( var i = 0; i < prefixes.length; i++ ) {
    ...
    prefix = prefixes[i];
    requestAnimationFrame = requestAnimationFrame || img[ prefix + 'RequestAnimationFrame' ];
    cancelAnimationFrame  = cancelAnimationFrame  || img[ prefix + 'CancelAnimationFrame' ] ||
                              img[ prefix + 'CancelRequestAnimationFrame' ];
  }
  ...
  var _Halftone = img.BreathingHalftone || {};
  ...
  Halftone.prototype.getCanvasPosition = function() {
    ...
    var x = rect.left + img.pageXOffset;
    var y = rect.top + img.pageYOffset;
  ...
  Halftone.prototype.bindEvents = function() {
    ...
    img.addEventListener( 'mousemove', this, false );
    img.addEventListener( 'touchmove', this, false );
    img.addEventListener( 'touchend', this, false );
    img.addEventListener( 'resize', this, false );
  };
  ...
  Halftone.prototype.unbindEvents = function() {
    ...
    img.removeEventListener( 'mousemove', this, false );
    img.removeEventListener( 'touchmove', this, false );
    img.removeEventListener( 'touchend', this, false );
    img.removeEventListener( 'resize', this, false );
  };
  ...
  Halftone.prototype.onmousedown = function( event ) {
    ...
    img.addEventListener( 'mouseup', this, false );
  };
  ...
  Halftone.prototype.onmouseup = function() {
    ...
    img.removeEventListener( 'mouseup', this, false );
  };
  ...
  Halftone.Vector = Vector;
  Halftone.Particle = Particle;
  img.BreathingHalftone = Halftone;
